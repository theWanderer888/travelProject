...
public class Scenic extends JFrame {
	 ...
	 * @throws Exception 
	 */
	public Scenic() throws Exception {
		setTitle("景点列表");
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				StoregoodsScenic view = null;
				try {
					view = new StoregoodsScenic();
	...
	void fillDate() throws Exception {
		...
		List<Store_table> storeByType = userService.getStoreByType(text,"景点");
