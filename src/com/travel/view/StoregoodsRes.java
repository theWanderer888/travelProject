...
public class StoregoodsRes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StoregoodsRes frame = new StoregoodsRes();
	 ...
	 * @throws Exception 
	 */
	public StoregoodsRes() throws Exception {
		setTitle("店铺商品列表");
	...
	void fillDate() throws Exception {
        ...
        List<Goods_table> storeGoodsList = goodsDAO.getStoreGoodsList(Restaurant.getid());
