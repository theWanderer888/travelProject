...
public class StoregoodsView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StoregoodsView frame = new StoregoodsView();
	 ...
	 * @throws Exception 
	 */
	public StoregoodsView() throws Exception {
		setTitle("店铺商品列表");
	...
	void fillDate() throws Exception {
        ...
        List<Goods_table> storeGoodsList = goodsDAO.getStoreGoodsList(Search.getid());
