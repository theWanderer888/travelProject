...
public class StoregoodsHetol extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StoregoodsHetol frame = new StoregoodsHetol();
	 ...
	 * @throws Exception 
	 */
	public StoregoodsHetol() throws Exception {
		setTitle("店铺商品列表");
	...
	void fillDate() throws Exception {
        ...
        List<Goods_table> storeGoodsList = goodsDAO.getStoreGoodsList(Hotel.getHotelId());
