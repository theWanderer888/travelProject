...
public class Search extends JFrame {
	...
	public Search() throws Exception {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				try {
					StoregoodsView view = new StoregoodsView();
	...
	void fillDate() throws Exception {
		...
		JTextField textField_search = UserMainPage.getSearch();
		String s = textField_search.getText(); 
		JTextField city = UserMainPage.getCity();
		String text = city.getText();
		List<Store_table> storeByType = userService.getStoreByName(text,s);
